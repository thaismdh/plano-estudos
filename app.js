...
$('#weekdayBtn').onclick=()=>{const moved=moveWeekends(state.sessions);save();toast(moved?`${moved} sessões movidas para dias úteis`:'Seu cronograma já respeita os dias úteis')};
